...
namespace Game
{
    ...
    public class MeshComponentsEditor : Editor
    {
        ...
        private Visualiation    m_visualization;
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Space(10);
            m_visualization = (Visualiation)EditorGUILayout.EnumPopup("Visualization", m_visualization);
        }
        ...
        private void OnSceneGUI()
        {
            ...
            if (m_visualization != Visualiation.None)
            {
